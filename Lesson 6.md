...
**Quiz: Which of the following statements will correctly create an object of type `Npc` and assign it to the variable `guard`? The `__init__` method of the class `Npc` takes two arguments: `self` and `greeting`.
